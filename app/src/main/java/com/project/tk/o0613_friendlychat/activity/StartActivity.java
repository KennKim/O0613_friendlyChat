...
public class StartActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void getServerKey() {
        FirebaseDatabase.getInstance().getReference(MyStr.CHILD_SERVER_KEY).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                MyStr.SERVER_KEY = dataSnapshot.getValue().toString();
            }
    ...
    private void initStart() {
        SharedPre.getInstance().init(getApplicationContext());
        String userName = SharedPre.getInstance().getString(SharedPre.DISPLAY_NAME, null);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_user_list) {
            ...
            startActivity(new Intent(StartActivity.this, ChatRoomListActivity.class));
